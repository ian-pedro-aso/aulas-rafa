...
@export var next_level: String = "res://cenas/fases/floresta.tscn"  # Caminho da cena de destino
@export var chave_necessaria_1 := true      # Porta exige a chave 1?
@export var chave_necessaria_2 := false       # Porta exige a chave 2?
@export var chave_necessaria_3 := false       # Porta exige a chave 3?
